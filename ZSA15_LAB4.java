...
public class ZSA15_LAB4 {
    ...
    public static void main(String[] args) {
        ...
        criteriaMicrowaveSpec.select(rootMicrowaveSpec).where(cb.like(rootMicrowaveSpec.get("sizes"), "%%"));
        ...
        predicates[0] = cb.like(rootMicrowave.get("brand"), "%%");
        predicates[1] = cb.like(rootMicrowave.get("model"), "%%");
